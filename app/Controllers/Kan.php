...
class Kan extends Controller
{
    ...
    public function add()
    {
        ...
        $data = array(
            'no' => date('y', strtotime($request->getPost('tgl_lantik'))) . '-03-' . $request->getPost('jabatan'),
    ...
    public function proses()
    {
        ...
        foreach ($sheet as $x => $excel) {
            ...
            if (
                $jabatan != NULL and ($jabatan['jabatan'] != 'Seksi Sako & Pusako' or $jabatan['jabatan'] != 'Seksi Adat & Sarak'
                    or $jabatan['jabatan'] != 'Seksi Permainan Anak Nagari')
            ) {
